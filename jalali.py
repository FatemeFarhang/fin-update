...
class Gregorian:
    ...
    def persian_string(self, date_format="{}-{}-{}"):
        if self.persian_day<10:
            persian_day = '0'+str(self.persian_day)
        else:
            persian_day = self.persian_day
        if self.persian_month<10:
            persian_month = '0'+str(self.persian_month)
        else:
            persian_month = self.persian_month

        return date_format.format(self.persian_year, persian_month, persian_day)
